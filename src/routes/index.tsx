...
const sectionTitle = "mt-4 font-display text-[38px] font-extrabold leading-[1.12] tracking-normal text-[#0E0F0C] sm:text-[46px] lg:text-[56px]";
      ...
      <section className="relative overflow-hidden border-b border-[rgba(14,15,12,0.12)] bg-[#F7F8F2] px-6 py-18 lg:py-24">
        ...
        <div className="relative mx-auto max-w-7xl">
          <div className="max-w-5xl">
            ...
            <h1 className="mt-8 max-w-5xl font-display text-[44px] font-extrabold leading-[1.12] tracking-normal text-[#0E0F0C] sm:text-[64px] lg:text-[80px] xl:text-[88px]">
              Đầu tư vào Việt Nam.
              <br />
              Rõ hơn. Nhanh hơn.
            </h1>
          ...
          <div className="mt-12 grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
            {STATS.map((item) => (
              ...
              >
                ...
                <p className="mt-5 font-display text-4xl font-extrabold leading-none tracking-normal text-[#0E0F0C]">
                  {item.value}
                </p>
            ...
            <div className="aspect-[4/5] overflow-hidden rounded-[28px] bg-[#E2F6D5] p-5 sm:aspect-[16/11]">
              ...
              <div className="mt-10 flex h-[72%] items-center justify-center rounded-[30px] bg-[#F7F8F2] ring-1 ring-[rgba(14,15,12,0.12)]">
                <div className="text-center">
                  ...
                  <p className="mt-5 text-2xl font-extrabold tracking-normal text-[#0E0F0C]">
          ...
          <div className="grid gap-5 lg:grid-cols-3">
            {OPPORTUNITIES.map((item) => (
              ...
              >
                ...
                <h3 className="mt-3 font-display text-[28px] font-extrabold leading-[1.12] tracking-normal text-[#0E0F0C] lg:text-[32px]">
                  {item.title}
                </h3>
          ...
          <div className="grid gap-5 lg:grid-cols-3">
            {FEATURED_NEWS.map((item) => (
              ...
              >
                ...
                <h3 className="mt-6 text-2xl font-extrabold leading-snug tracking-normal text-[#0E0F0C]">
                  {item.title}
                </h3>
        ...
        <div className="mx-auto grid max-w-7xl gap-10 lg:grid-cols-[1fr_1.2fr] lg:items-center">
          ...
          <div className="grid grid-cols-2 gap-3 sm:grid-cols-3">
            {["FDI", "KCN", "Logistics", "Chính sách", "Cao tốc", "PCI"].map((item) => (
              ...
              >
                <p className="text-2xl font-extrabold leading-none tracking-normal text-[#0E0F0C]">
                  {item}
                </p>
              </div>
            ))}
      ...
      <section className="bg-[#0E0F0C] px-6 py-16 text-white lg:py-20">
        <div className="mx-auto max-w-7xl rounded-[40px] bg-[#9FE870] p-8 text-[#163300] sm:p-10 lg:p-12">
          <div className="grid gap-8 lg:grid-cols-[1fr_auto] lg:items-end">
            <div>
              <h2 className="font-display text-[38px] font-extrabold leading-[1.12] tracking-normal sm:text-[46px] lg:text-[56px]">
